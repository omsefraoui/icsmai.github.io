...
export default function Keynotes() {
  const speakers = [
    ...
    }, 
    {
      ...
      topic: "Connected health: what future challenges?",
    },
    {
    ...
    }, 
     {
      ...
      bio: "Mohammed Mestari received the M.A. degree fromthe École Normale Supérieure de l’Enseignement Technique (ENSET), Mohammedia, Morocco, in 1991, and the Ph.D. degrees in applied mathematics and artiﬁcial intelligence from the Faculty of Science Ben M’Sick, Hessan II University, Casablanca, Morocco, in 1997 and 2000, respectively. He is currently a Professor of Applied Mathematics and Artificial Intelligence at ENSET, and the Head of the Artiﬁcial Intelligence Research Team with the Laboratory of Signals, Distributed Systems and Artiﬁcial Intelligence. Prof. Mohammed MESTARI is Co-founder of the International Neural Network Society Morocco Chapter (INNS Morocco Chapter), Co-founder of the IEEE Computational Intelligence Morocco Chapter, and Senior Member of the IEEE Transactions on Neural Network and Learning Systems (IEEE TNNLS). His current research interests include neural networks for image classification, data-driven approach, neural networks hardware implementation, high-speed and/or low-power techniques and systems for neural networks, and theoretical issues directly related to hardware implementation of techniques based on the principle of decomposition coordination for optimal control and trajectory planning for an Unmanned Aerial Vehicle (UAV) and a robot.", 
      topic: "",
    },
     /*{
