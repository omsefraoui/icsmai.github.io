...
export default function ProgramICSMAI2025Fixed() {
  ...
  const schedules: Record<(typeof days)[number]["id"], ItemType[]> = {
    ...
    day2: [
      ...
      { time: "15:30 – 17:00", title: "Keynotes Block #3 (Healthcare Innovations)", location: "Conference Hall", type: "keynote", details: "#7 Prof. Mohammed Choukri · #8 Prof. Dounia El Moujtahide · #9 Prof. El Houcine Sebbar · #10 Prof. Abderrazak Saddari · ", icon: <Presentation className="h-5 w-5" /> },
    ...
    day3: [
      { time: "08:00 – 09:00", title: "Welcome & Registration", location: "Main Conference Registration", type: "registration", icon: <Users className="h-5 w-5" /> },
      { time: "09:00 – 10:30", title: "Keynotes Block #4", location: "Conference Hall", type: "keynote", details: "Prof. Muhamad Umar Khan — Empowering Healthcare with IoT & AI; Prof. Mostafa Azizi — MIoT & Security Challenges", icon: <Presentation className="h-5 w-5" /> },
