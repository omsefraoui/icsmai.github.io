...
papers: [
      ...
      { "Vinay Dandamraj", title: "Smart IoT based Hydroponics Farming" },
      { "Mirthika  B", title: "Intelligent Wildlife Monitoring and Repulsion Using YOLOv8-Based Bounding Box" },
